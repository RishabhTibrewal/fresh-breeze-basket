...
export const sidebarRoutes: Record<string, string> = {
  ...
  'report-pending-deliveries':   '/reports/sales/pending-deliveries',
  'report-sales-returns':        '/reports/sales/returns',
  'report-hourly-heatmap':       '/reports/sales/hourly-heatmap',
  'report-payment-mix':          '/reports/sales/payment-mix',
  'report-fulfillment-mix':      '/reports/sales/fulfillment-mix',
  'report-discount-impact':      '/reports/sales/discount-impact',
  'report-cashier-performance':  '/reports/sales/cashier-performance',
  'report-category-brand':       '/reports/sales/category-brand',
  'report-basket-metrics':       '/reports/sales/basket-metrics',
  'report-modifier-revenue':     '/reports/sales/modifier-revenue',
  'report-trend-comparison':     '/reports/sales/trend-comparison',
  'report-movers':               '/reports/sales/movers',
  'report-outlet-leaderboard':   '/reports/sales/outlet-leaderboard',
