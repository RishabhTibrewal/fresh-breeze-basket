...
import posKotRouter from './routes/posKot';
import posMenusRouter from './routes/posMenus';
import warehouseManagersRouter from './routes/warehouseManagers';
import posManagersRouter from './routes/posManagers';
...
app.use('/api/pos/kot', posKotRouter);
app.use('/api/pos/menus', posMenusRouter);
app.use('/api/warehouse-managers', warehouseManagersRouter);
app.use('/api/pos-managers', posManagersRouter);
